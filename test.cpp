...
int main() {
    ...
    EnergyLoss *carbon = new EnergyLoss("CarbonCsI.dat");
    ...
    printf("\t 0.5 MeV 12C after 0.001mm CsI. Initial Energy: %8.4f MeV\n", carbon->AddBack(0.5, 0.001));
    printf("\t\t SRIM Value: 1.33 MeV\n");
    printf("\t 1 MeV 12C after 0.1mm CsI. Initial Energy: %8.4f MeV\n", carbon->AddBack(1., 0.1));
    printf("\t\t SRIM Value: 70.99 MeV\n");
